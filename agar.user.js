...
// @version      0.1
// @author       Solana-boy
// @match        https://shiba-bank.89-124-91-186.sslip.io/*
// @downloadURL  https://github.com/solana-boy/test-violentmonkey/raw/main/agar.user.js
// @updateURL    https://github.com/solana-boy/test-violentmonkey/raw/main/agar.user.js
...
async function autoBuy() {
  ...
  up = Array.from(document.querySelectorAll('section button')).filter(el => el.textContent.includes("Смотреть рекламу"));
  if (up.length != 0){
    triggerEvents(up[0]);
    await sleep(getRandomDelay(60000, 70000));
  }
